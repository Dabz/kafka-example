...
public class EmbeddedKafkaCluster {
    ...
    private KafkaServer startBroker(Properties props) {
        KafkaServer server = new KafkaServer(new KafkaConfig(props), Time.SYSTEM, Option.apply("thread"), new ArrayBuffer<>());
        server.startup();
        return server;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("org.example.EmbeddedKafkaCluster{");
