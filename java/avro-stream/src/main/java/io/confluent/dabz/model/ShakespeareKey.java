...
public class ShakespeareKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.confluent.dabz.model.ShakespeareKey.Builder newBuilder() {
    return new io.confluent.dabz.model.ShakespeareKey.Builder();
  }
   ...
   * @return A new ShakespeareKey RecordBuilder
   */
  public static io.confluent.dabz.model.ShakespeareKey.Builder newBuilder(io.confluent.dabz.model.ShakespeareKey.Builder other) {
    return new io.confluent.dabz.model.ShakespeareKey.Builder(other);
  }
   ...
   * @return A new ShakespeareKey RecordBuilder
   */
  public static io.confluent.dabz.model.ShakespeareKey.Builder newBuilder(io.confluent.dabz.model.ShakespeareKey other) {
    return new io.confluent.dabz.model.ShakespeareKey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareKey>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.confluent.dabz.model.ShakespeareKey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.confluent.dabz.model.ShakespeareKey other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.work)) {
        this.work = data().deepCopy(fields()[0].schema(), other.work);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.dabz.model.ShakespeareKey.Builder clearWork() {
      work = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.dabz.model.ShakespeareKey.Builder setYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.dabz.model.ShakespeareKey.Builder clearYear() {
